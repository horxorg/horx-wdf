...
<script type="text/html" id="toolbar">
    <div class="layui-btn-group" >
        <@wdf.permissionAllowed code="sys.dict.item"><button class="layui-btn" lay-event="create"><i class="layui-icon layui-icon-add-circle"></i><span><@spring.message "sys.dict.item.createSub"/></span></button></@wdf.permissionAllowed>
...
<#include "../../inc/js.ftl">
<script src="${rc.contextPath}/js/page/sys/dict/itemTree.js?${staticVer}"></script>
</body>
</html>
